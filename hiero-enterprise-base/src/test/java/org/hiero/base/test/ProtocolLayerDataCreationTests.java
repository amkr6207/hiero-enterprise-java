    ...
    Assertions.assertDoesNotThrow(
        () ->
            new HookStoreRequest(
                maxTransactionFee, transactionValidDuration, hookId, storageUpdates));
    Assertions.assertDoesNotThrow(() -> HookStoreRequest.of(hookId, storageUpdates));
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new HookStoreRequest(null, transactionValidDuration, hookId, storageUpdates));
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new HookStoreRequest(maxTransactionFee, null, hookId, storageUpdates));
    Assertions.assertThrows(
        NullPointerException.class,
        () ->
            new HookStoreRequest(
                maxTransactionFee, transactionValidDuration, null, storageUpdates));
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new HookStoreRequest(maxTransactionFee, transactionValidDuration, hookId, null));
    Assertions.assertThrows(
        NullPointerException.class, () -> HookStoreRequest.of(null, storageUpdates));
    Assertions.assertThrows(NullPointerException.class, () -> HookStoreRequest.of(hookId, null));
  }
